...
<template>
    <v-row>
        ...
        <v-col class="text-center mt-2">
            <p class="text-muted">Ctk@HospitaL Design and Developed<a flat variant="text" href="https://www.wrappixel.com/" target="_blank" class="pl-1 text-primary">wrappixel.com</a></p>
        </v-col>
    </v-row>
</template>